...
bool waitForStraightLineORLeft(uint8_t currentState) {
  ...
  if ((currentState == ON_LINE) || ((millis() - timeStamp) > 1700)) {
    ret = true;
  }
  return ret;
}
...
const steering_table_t straightSteer[] = {
  ...
  { .state = GOING_RIGHT,           .leftDutyCycle = SPEED(18),         .rightDutyCycle = SPEED(45), .rightMotor = MD_FORWARD, .leftMotor = MD_FORWARD,    .nextStateFunc = NULL,                        .delay = 0,   .indicator = 8 },
  { .state = GOING_LEFT,            .leftDutyCycle = SPEED(45), .rightDutyCycle = SPEED(18),         .rightMotor = MD_FORWARD,   .leftMotor = MD_FORWARD,  .nextStateFunc = NULL,                        .delay = 0,   .indicator = 9 },
  
  { .state = GOING_RIGHT_0,         .leftDutyCycle = SPEED(15),         .rightDutyCycle = SPEED(45), .rightMotor = MD_FORWARD, .leftMotor = MD_FORWARD,    .nextStateFunc = NULL,                        .delay = 0,   .indicator = 8 },
  { .state = GOING_RIGHT_1,         .leftDutyCycle = SPEED(15),         .rightDutyCycle = SPEED(45), .rightMotor = MD_FORWARD, .leftMotor = MD_FORWARD,    .nextStateFunc = NULL,                        .delay = 0,   .indicator = 8 },
  { .state = GOING_RIGHT_2,         .leftDutyCycle = SPEED(15),         .rightDutyCycle = SPEED(45), .rightMotor = MD_FORWARD, .leftMotor = MD_FORWARD,    .nextStateFunc = NULL,                        .delay = 0,   .indicator = 8 },
  { .state = GOING_RIGHT_3,         .leftDutyCycle = SPEED(15),         .rightDutyCycle = SPEED(45), .rightMotor = MD_FORWARD, .leftMotor = MD_FORWARD,    .nextStateFunc = waitForStraightLineORLeft,   .delay = 0,   .indicator = 8 },
  ...
  { .state = DEAD_END,              .leftDutyCycle = SPEED(38), .rightDutyCycle = SPEED(38), .rightMotor = MD_FORWARD, .leftMotor = MD_FORWARD,  .nextStateFunc = NULL,                        .delay = 1200, .indicator = NO_INDICATION },
  { .state = INTERSECTION_DEAD,     .leftDutyCycle = SPEED(0),  .rightDutyCycle = SPEED(35), .rightMotor = MD_BRAKE,   .leftMotor = MD_FORWARD,  .nextStateFunc = waitForStraightLineORLeft,   .delay = 1200, .indicator = NO_INDICATION },

  { .state = SHARP_RIGHT_TURN_0,    .leftDutyCycle = SPEED(55), .rightDutyCycle = SPEED(10), .rightMotor = MD_BACKWARD, .leftMotor = MD_FORWARD, .nextStateFunc = waitForStraightLineORRight,  .delay = 1200, .indicator = 10 },
 // { .state = SHARP_RIGHT_TURN_1,    .leftDutyCycle = SPEED(35), .rightDutyCycle = SPEED(10), .rightMotor = MD_BACKWARD, .leftMotor = MD_FORWARD, .nextStateFunc = waitForStraightLineORRight,  .delay = 900, .indicator = 10 },
  { .state = SHARP_RIGHT_TURN_2,    .leftDutyCycle = SPEED(55), .rightDutyCycle = SPEED(10), .rightMotor = MD_BACKWARD, .leftMotor = MD_FORWARD, .nextStateFunc = waitForStraightLineORRight,  .delay = 1200, .indicator = 10 },
 ...
 // { .state = SHARP_RIGHT_TURN_4,    .leftDutyCycle = SPEED(35), .rightDutyCycle = SPEED(10), .rightMotor = MD_BACKWARD, .leftMotor = MD_FORWARD, .nextStateFunc = waitForStraightLineORRight,  .delay = 900, .indicator = 10 },
  { .state = GRADUAL_RIGHT_TURN,    .leftDutyCycle = SPEED(55), .rightDutyCycle = SPEED(10), .rightMotor = MD_BACKWARD, .leftMotor = MD_FORWARD, .nextStateFunc = waitForStraightLineORRight,  .delay = 1200, .indicator = 10 },
  { .state = GRADUAL_RIGHT_TURN_OP, .leftDutyCycle = SPEED(55), .rightDutyCycle = SPEED(10), .rightMotor = MD_BACKWARD, .leftMotor = MD_FORWARD, .nextStateFunc = handleRightOp,               .delay = 1350, .indicator = 10 },

  { .state = SHARP_LEFT_TURN_0,     .leftDutyCycle = SPEED(10), .rightDutyCycle = SPEED(55), .rightMotor = MD_FORWARD, .leftMotor = MD_BACKWARD, .nextStateFunc = waitForStraightLineORLeft,   .delay = 1200, .indicator = 11 },
 // { .state = SHARP_LEFT_TURN_1,     .leftDutyCycle = SPEED(10), .rightDutyCycle = SPEED(35), .rightMotor = MD_FORWARD, .leftMotor = MD_BACKWARD, .nextStateFunc = waitForStraightLineORLeft,   .delay = 900, .indicator = 11 },
  { .state = SHARP_LEFT_TURN_2,     .leftDutyCycle = SPEED(10), .rightDutyCycle = SPEED(55), .rightMotor = MD_FORWARD, .leftMotor = MD_BACKWARD, .nextStateFunc = waitForStraightLineORLeft,   .delay = 1200, .indicator = 11 },
 ...
 // { .state = SHARP_LEFT_TURN_4,     .leftDutyCycle = SPEED(10), .rightDutyCycle = SPEED(35), .rightMotor = MD_FORWARD, .leftMotor = MD_BACKWARD, .nextStateFunc = waitForStraightLineORLeft,   .delay = 900, .indicator = 11 },
  { .state = GRADUAL_LEFT_TURN,     .leftDutyCycle = SPEED(10), .rightDutyCycle = SPEED(55), .rightMotor = MD_FORWARD, .leftMotor = MD_BACKWARD, .nextStateFunc = waitForStraightLineORLeft,   .delay = 1200, .indicator = 11 },
  { .state = GRADUAL_LEFT_TURN_OP,  .leftDutyCycle = SPEED(10), .rightDutyCycle = SPEED(55), .rightMotor = MD_FORWARD, .leftMotor = MD_BACKWARD, .nextStateFunc = handleLeftOp,                .delay = 1350, .indicator = 11 },
};
